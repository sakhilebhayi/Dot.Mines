...
class Documentation extends Component
{
     ...
     * the generator owns whether the result is cached, so the page and the
     * published spec can never disagree about how fresh they are.
     *
    ...
    public function getApiReferenceProperty(): array
    {
        ...
        return app(OpenApiGenerator::class)->cachedReference();
    }
