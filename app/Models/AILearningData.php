 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder|AILearningData where(string $column, mixed $operator = null, mixed $value = null)
 * @method static \Illuminate\Database\Eloquent\Builder|AILearningData whereIn(string $column, array $values)
 * @method static \Illuminate\Database\Eloquent\Builder|AILearningData orderBy(string $column, string $direction = 'asc')
 * @method static AILearningData|null find(mixed $id, array $columns = ['*'])
