<nav id="mobile-sidebar"
    ...
    <div class="p-4 space-y-2">
        ...
        <!-- Operations Feed -->
        <a href="{{ route('feed') }}"
           class="nav-link px-4 py-3 rounded-lg transition-colors flex items-center gap-3 {{ request()->routeIs('feed') ? 'bg-[var(--gold)] text-[var(--ink)]' : 'text-[var(--sand)] hover:bg-white/5 hover:text-[var(--stone)]' }}"
           :class="{ 'justify-center': !expanded }"
           :title="!expanded ? 'Feed' : ''">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path>
            </svg>
            <span class="whitespace-nowrap overflow-hidden transition-all duration-300" x-show="expanded">Feed</span>
        </a>
