...
<div class="w-full">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div class="stat bg-base-200 rounded-lg">
            ...
            <div class="stat-value text-sm">{{ \App\Support\Currency::format($maintenanceStats['total_cost'], $teamCurrency) }}</div>
        </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                            ...
                            <div class="flex items-center gap-2 text-green-300 text-sm mb-2">
                                ...
                                <span>Preventive: {{ \App\Support\Currency::format($recommendation['estimated_savings'] * 0.2, $teamCurrency) }} vs Breakdown: {{ \App\Support\Currency::format($recommendation['estimated_savings'], $teamCurrency) }}</span>
                            </div>
                            @endif
