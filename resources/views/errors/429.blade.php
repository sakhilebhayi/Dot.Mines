...
@section('icon')
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#8a5f18" stroke-width="1.75"><circle cx="12" cy="13" r="8" stroke-linecap="round"/><path d="M10 10v6M14 10v6" stroke-linecap="round"/><path d="M9 2h6" stroke-linecap="round"/></svg>
@endsection
